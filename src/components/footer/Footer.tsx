        ...
        <div className="max-w-7xl mx-auto">
          <div className="lg:flex justify-between">
            <div className="w-full lg:w-[47%]">
              <Link
                to="/"
                className="uppercase text-xl pb-5 mb-5 block font-bold lg:text-xl"
              >
                INVESTINSPIRE
              </Link>
              ...
              <div>
                <p className="w-full lg:w-[60%]">
                  ...
                  InvestInspire. All rights reserved. <br /> <br />© 2024
                  InvestInspire (MU).
                </p>
              </div>
            </div>
          ...
          <div className="text-sm pt-10 pb-10 italic">
            <p>
              ...
              initial investment. It is not suitable for everyone. Before making
              any decisions in relation to a financial product, you should
              obtain and consider our Disclosure Statement (DS) available on our
              website and seek independent advice if necessary.
            </p>
            <br />
            <p>
              The information on this website is of a general nature only and
              does not consider your goals, financial situation or needs. Every
              effort is made to provide accurate information. However, the
              information is subject to change at any time without notice. GO
              cannot guarantee and assume no legal responsibility for the
              relevance, accuracy, topicality or completeness of the
              information.
            </p>
            <br />
            <p>
              We use a number of cookies on this website for functional,
              analytical and marketing purposes. By continuing to use this
              website, you agree to our use of cookies. You can view our cookie
              policy here from the Privacy Policy or by following the link at
              the bottom of any page of our website.
            </p>
            <br />
          </div>
        </div>

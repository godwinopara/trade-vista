    ...
    <section className=" xl:mb-0 min-h-[80vh] py-24 xl:my-0 max-w-7xl mx-auto px-6  xl:flex xl:justify-between xl:items-center xl:gap-x-10">
      <div className="text-center mb-20 xl:text-left xl:mb-0 w-full lg:w-2/3">
        ...
        <p className="text-lg text-gray-500 mb-10">
          Trade on popular cryptocurrencies with leverage, from bitcoin and
          ethereum to TRON and NEO, on our award-winning spread betting and CFD
          platform. With tight spreads, lightning-fast execution and the highest

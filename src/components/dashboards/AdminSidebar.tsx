...
export const AdminSidebar = ({ sidebarOpen, setSidebarOpen }: Props) => {
  ...
  return (
    <aside
      className={`absolute left-0 top-0 z-[9999] flex h-screen w-[18.125rem] flex-col overflow-y-hidden bg-primary duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${

      ...
      >
        ...
        <div>
          ...
          <div className="relative z-20 mb-3">
            <select
              ...
              className="relative text-sm z-20 w-full text-white appearance-none rounded border border-stroke bg-primary py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input"
            >
          ...
          <div>
            ...
            <div className="relative z-20 mb-3">
              <select
                ...
                className="relative text-sm z-20 w-full text-white appearance-none rounded border border-stroke bg-primary py-3 px-5 outline-none transition focus:border-white active:border-white dark:border-form-strokedark dark:bg-form-input"
              >
        ...
        <div className="mb-3">
          ...
          <input
            ...
            type="text"
            placeholder="500"
            className="w-full text-white rounded-lg border-[1.5px] border-stroke bg-primary py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
          />
        </div>
        <div className="mb-3">
          ...
          <div className="relative z-20 bg-white dark:bg-form-input mb-3">
            <select
              ...
              className="relative text-white text-sm z-20 w-full appearance-none rounded border border-stroke bg-primary py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input"
            >
        ...
        <button
          type="submit"
          disabled
          className="inline-flex w-full items-center justify-center rounded-md bg-meta-3 py-3 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10 cursor-pointer"
        >
          Place Order
        </button>
      </form>

...
export const TradingSession = (props: Props) => {
	...
	return (
		<div className="bg-white rounded-lg">
			<div className="px-6 pt-6 text-black border-b border-b-white">
				<h3 className="uppercase text-base font-semibold">trading session</h3>
			</div>
			<form onSubmit={handleSubmit} className="col-span-12 xl:col-span-3  px-6 py-6">
				<div>
					<label className="mb-3 block text-black font-bold">Trade Options</label>
					<div className="relative z-20  mb-3">
						<select
							value={tradeOption}
							onChange={(e) => setTradeOption(e.target.value)}
							required
							className="relative text-black rounded-lg z-20 w-full appearance-none border-[1.5px] font-medium border-stroke bg-white py-3 px-5 outline-none transition focus:border-primary active:border-white dark:border-form-strokedark dark:bg-form-input"
						>
				...
				<div className="mb-3">
					...
					<input
						...
						type="text"
						placeholder="500"
						className="w-full text-black rounded-lg border-[1.5px] border-stroke bg-white py-3 px-5 font-medium outline-none transition focus:border-primary active:border-white disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
					/>
				</div>
				<div className="mb-3">
				...
				<div className="mb-5">
					<label className="mb-3 block text-black font-bold">Time in Force</label>
					<div className="relative z-20 bg-white dark:bg-form-input mb-3">
						<select
							required
							className="relative text-black rounded-lg z-20 w-full appearance-none border-[1.5px] font-medium border-stroke bg-white py-3 px-5 outline-none transition focus:border-primary active:border-white dark:border-form-strokedark dark:bg-form-input"

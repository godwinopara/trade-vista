...
import loader from "../components/icons/spinner.svg"
      ...
      <div>
        ...
        <div className="mb-20 text-center rounded-md border border-stroke  bg-white py-8 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          {verificationStatus === "Not Verified" && (
            <p>
              Your account is not verified. To verify your account, please fill
              out the form to request verification.
            </p>
          )}
          ...
          {verificationStatus === "Pending" && (
            <div className="flex flex-col text-center justify-center items-center text-2xl mt-8 pb-8">
              ...
              <div>
                ...
                <p>
                  You will receive a mail from us once it has been verified.
                </p>
              </div>
            </div>
          )}
        ...
        {!uploaded && (
          <div className="mb-10 flex justify-center items-center gap-3">
            <div>
              <p className="mb-1.5 text-black dark:text-white text-center">
                SUBMIT VERIFICATION
              </p>
              <p className="xl:w-[70%] text-center xl:mx-auto">
                To request an account verification, kindly provide your
                information with a valid means of Identification attached as an
                image document.
              </p>
            </div>
          </div>
        ...
        {!uploaded && (
          <form onSubmit={handleImageUpload}>
            ...
            <div className="flex justify-center">
              <button
                className="flex justify-center md:w-1/2 mx-auto rounded bg-primary text-white py-3 px-6 font-medium text-gray hover:bg-opacity-95"
                type="submit"
              >
